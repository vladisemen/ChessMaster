...
namespace ChessMaster.Фигуры
{
    ...
    /// Слон
    /// </summary>
    public class BishopChessFigure : ChessFigure
    {
        public BishopChessFigure(EChessColor color) : base(color)
        {
        }
        ...
        internal ArrayList TureHod(int x, int y)
        {
        ...
        internal ArrayList BishopHod(int x, int y)
        {
            ArrayList array = new ArrayList();
            for (int i = 0; i < 8; i++)
            {
